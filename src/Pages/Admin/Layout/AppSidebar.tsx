...
const navItems: NavItem[] = [
...

  {
    ...
    roles: ["Admin"],
    subItems: [
      { name: "Events Status", path: "/admin/event" },
      { name: "Create Event", path: "/admin/event/add" },
      { name: "Manage Registrations", path: "/manage-registrations" },
    ],
  },

  {
    ...
    roles: ["Admin"],
    subItems: [
      { name: "View All", path: "/admin/user" },
      { name: "Create New", path: "/admin/user/add" },
    ],
  },

  {
    ...
    roles: ["Admin"],
    subItems: [
      { name: "View All", path: "/admin/gallery" },
      { name: "Create New", path: "/admin/gallery/add" },
    ],
  },
...

  {
    ...
    roles: ["Admin"],
    subItems: [
      { name: "View All", path: "/admin/blogs" },
      { name: "Create New", path: "/admin/blogs/create" },
    ],
  },
];
...
const AppSidebar: React.FC = () => {
  ...
  const renderMenuItems = (items: NavItem[], menuType: "main" | "others") => (
    <ul className="flex flex-col gap-4">
      {items.filter((items) => {
        return items.roles
          ? items.roles.some((allowedRole) => user.role.includes(allowedRole))
          : true;
      })
        .map((nav, index) => (
          <li key={nav.name}>
